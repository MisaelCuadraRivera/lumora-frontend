...
import { Calendar as CalendarIcon, Plus, Image as ImageIcon, Upload, X, Loader2, MapPin } from "lucide-react"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const eventData: any = {
        ...
        imageKey: imageKey, // Clave S3 de la imagen
        bannerKey: bannerKey // Clave S3 del banner
      }
      ...
      // Construir el objeto de ubicación conforme a la interfaz EventLocation para evitar fallos de renderizado
      eventData.location = {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-start">
            ...
            <div className="space-y-4 bg-muted/10 p-5 rounded-2xl border border-border/30 backdrop-blur-sm shadow-sm hover:border-border/50 hover:bg-muted/15 transition-all duration-300">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="title" className="text-xs font-medium text-muted-foreground">Título del Evento *</Label>
                <Input
                  id="title"
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                <div className="space-y-1.5">
                  <Label htmlFor="type" className="text-xs font-medium text-muted-foreground">Tipo de Evento</Label>
            ...
            <div className="space-y-4 bg-muted/10 p-5 rounded-2xl border border-border/30 backdrop-blur-sm shadow-sm hover:border-border/50 hover:bg-muted/15 transition-all duration-300">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  <Label htmlFor="startDate" className="text-xs font-medium text-muted-foreground">Fecha Inicio *</Label>
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="endDate" className="text-xs font-medium text-muted-foreground">Fecha Fin</Label>
                  <div className="flex gap-2 items-center">
                    <Input
                      id="endDate"
                      type="datetime-local"
              ...
              <div className="space-y-3 transition-all duration-300">
                {(formData.type === "offline" || formData.type === "hybrid") && (
                  <div className="space-y-1.5 animate-in fade-in slide-in-from-top-1 duration-200">
                    <Label htmlFor="location" className="text-xs font-medium text-muted-foreground">Ubicación Física *</Label>
                    <Input
                      id="location"
                ...
                {(formData.type === "online" || formData.type === "hybrid") && (
                  <div className="space-y-1.5 animate-in fade-in slide-in-from-top-1 duration-200">
                    <Label htmlFor="onlineUrl" className="text-xs font-medium text-muted-foreground">URL del Evento Online *</Label>
                    <Input
                      id="onlineUrl"
              ...
              <div className="border-t border-border/20 pt-2 space-y-3">
                <div className="flex items-center justify-between p-2.5 rounded-xl bg-background/40 border border-border/30">
                  <Label htmlFor="isPublic" className="text-xs font-semibold cursor-pointer">¿Es público?</Label>
                  <Switch
                    id="isPublic"
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    <Label htmlFor="maxAttendees" className="text-xs font-medium text-muted-foreground">Máx. Asistentes</Label>
                    <Input
                      id="maxAttendees"
                      type="number"
