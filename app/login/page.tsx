          ...
          >
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-2 gap-3 mt-6">
                <Button
                  variant="outline"
                  className="cursor-pointer h-11 bg-black/30 border-white/20 text-white hover:border-white/30 rounded-lg backdrop-blur-sm transition-all duration-300 flex items-center justify-center gap-2"
                >
                  <svg
                    className="w-5 h-5"
                    viewBox="0 0 24 24"
                ...
                <Button
                  variant="outline"
                  className="cursor-pointer h-11 bg-white/95 border-white/20 text-gray-700 hover:bg-white hover:border-gray-300 rounded-lg backdrop-blur-sm transition-all duration-300 flex items-center justify-center gap-2"
                >
